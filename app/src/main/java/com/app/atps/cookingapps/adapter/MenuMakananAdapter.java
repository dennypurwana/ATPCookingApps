...
public class MenuMakananAdapter  extends RecyclerView.Adapter<MenuMakananAdapter.MenuMakananHolder>{
    ...
    public MenuMakananHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_menu_makanan,
                parent, false);
